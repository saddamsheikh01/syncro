...
const SocialButton = ({ icon, label, color, onClick }: SocialButtonProps) => (
  ...
  >
    <span
      className="flex h-12 w-12 items-center justify-center rounded-full border border-border/70 bg-surface-muted text-muted transition-all group-hover:scale-105 group-hover:shadow-md"
    ...
    <span className="text-[10px] font-medium text-subtle">{label}</span>
  </button>
);

export interface ShareInsightCardProps {
  testTitle: string;
  recap: string;
}

export const ShareInsightCard = ({
  testTitle,
  recap,
  ...
  return (
    <Card className="relative overflow-hidden p-6">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(75,124,240,0.08),_transparent_60%)]" />
