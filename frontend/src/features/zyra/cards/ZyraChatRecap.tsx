...
export const ZyraChatRecap = ({
  ...
  const handleDeleteAll = async () => {
    ...
    try {
      ...
      setError("Unable to delete chats. Try again.");
    } finally {
      setDeleting(false);
    }
  };
  ...
  return (
    ...
    >
        ...
        {!loading && !error && data ? (
          <div className="flex items-center justify-between border-t border-border/40 pt-3">
            <p className="text-[10px] text-subtle">
              Generated by Zyra based on your conversations
            </p>
            <div className="flex items-center gap-2">
              <Button
                size="sm"
      ...
      <Modal
        open={confirmOpen}
        title="Delete all Zyra chats?"
        description="This action is final. All Zyra sessions will be deleted."
