...
function ActivationPlanningMove({ cityName = "Lisbon", budget = 2500, estimatedCost = 2075 }: {
    ...
    <div className="activation-main">
      ...
      <div className="activation-grid">
        ...
        <div className="act-col">
          ...
          <div className="act-card">
            <div className="act-card__img-area"><span style={{ fontSize: '4rem' }}>💬</span></div>
            <p className="act-card__badge act-card__badge--free">🆓 Free – Community Lounge</p>
            <p className="act-badge-desc">Read Discussions. Ask Questions. Join Local Events.</p>
            <p className="act-card__badge act-card__badge--premium">🌟 Premium – Target Lounge</p>
            <p className="act-badge-desc">Get Matched With Curated Groups Based On Your Budget, Relocation Stage And Lifestyle.</p>
          </div>
          <div className="act-card act-card--warning">
            <div className="act-card__img-area"><span style={{ fontSize: '3.5rem' }}>⚠️</span></div>
        ...
        <div className="act-col">
          <div className="act-card">
            ...
            <p className="act-mentor-insight">
              <strong>People Who Relocated With This Structure Avoided Up To €6,000 In Early Mistakes.</strong>
            </p>
          ...
          <div className="act-card">
            ...
            <p className="act-budget-row">🏠 Estimated Monthly Cost — €{estimatedCost.toLocaleString()}</p>
            <p className="act-budget-row">💳 Your Declared Budget — €{budget.toLocaleString()}</p>
            <p className="act-budget-row">📉 Remaining Margin — €{margin}</p>
            <p className={`act-budget-result ${margin > 0 ? "act-budget-result--ok" : "act-budget-result--risk"}`}>
              {margin > 0 ? "● Result: Financially Sustainable" : "● Result: Budget Tight"}
            </p>
          </div>
          ...
          <div className="act-card">
            ...
            <p className="act-card__subtitle">Sometimes You Just Need Clarity.</p>
            <p className="act-check-item">✓ Get Answers To Your Questions</p>
            <p className="act-check-item">✓ Understand The Next Step</p>
            <p className="act-check-item">✓ Find The Right People And Resources</p>
          </div>
        </div>
      </div>
    </div>
...
function ActivationUnsure({ topCity = "Valencia" }: { topCity?: string }) {
  ...
  return (
    <div className="activation-main">
      ...
      <div className="activation-header">
        <h1 className="activation-title">{topCity} Looks Like Your Strongest Match<br />But 3 Decisions Will Determine If The Move Works</h1>
        <p className="activation-subtitle">
          Based On Your Profile, {topCity} Currently Fits Many Of Your Priorities.<br />
          Housing Timing, Budget Margin And Local Network Will Shape Your Success.
        </p>
      </div>
      <div className="activation-grid">
        <div className="act-col">
          ...
          <div className="act-card">
            <span style={{ fontSize: '3rem', display: 'block', textAlign: 'center', marginBottom: 8 }}>💬</span>
            <p className="act-card__badge act-card__badge--free">🆓 Free – Community Lounge</p>
            <p className="act-badge-desc">Read Discussions. Ask Questions. Join Local Events.</p>
            <p className="act-card__badge act-card__badge--premium">🌟 Premium – Target Lounge</p>
            <p className="act-badge-desc">Get Matched With Curated Groups Based On Your Budget, Relocation Stage And Lifestyle.</p>
          ...
          <div className="act-card act-card--warning">
            ...
            <p className="act-month__body">Rent Prices May Rise Quickly. Syncro Suggests Budget-Compatible Neighborhoods And Safer Options.</p>
          </div>
        </div>
        ...
        <div className="act-col">
          <div className="act-card">
            <div className="act-mentor-preview"><div className="act-mentor-dot" /><span className="act-mentor-label">MENTOR PREVIEW</span></div>
            <div className="act-mentor-row">
              <div className="act-mentor-avatar">👨</div>
              <div><p className="act-mentor-name">Marco</p><p className="act-mentor-route">Milan → Lisbon · In 4 Months</p></div>
            </div>
            <p className="act-mentor-insight"><strong>People Who Relocated With This Structure Avoided Up To €6,000 In Early Mistakes.</strong></p>
            <div className="act-mentor-tiers">
              <p>📱 Free: 15-Min Preview</p>
              <p>⭐ Premium: 30 Min / Month + Target Lounge Access</p>
            </div>
          ...
          <div className="act-card">
            ...
            <p className="act-budget-result act-budget-result--ok">● Result: Financially Sustainable</p>
          </div>
          <div className="act-card">
            <h3 className="act-card__title">🔄 PLATFORM SUPPORT</h3>
            <p className="act-check-item">✓ Get Answers To Your Questions</p>
...
function ActivationAlreadyThere({ cityName = "Lisbon" }: { cityName?: string }) {
  ...
  return (
    <div className="activation-main">
      ...
      <div className="activation-header">
        <h1 className="activation-title">You're In {cityName}. Now Let's Make It Work Fully For You.</h1>
        <p className="activation-subtitle">
          Based On Your Profile, There Are Several Areas Where {cityName} Could Work Better For Your Lifestyle.<br />
      ...
      <div className="activation-grid">
        <div className="act-col">
          ...
          <div className="act-card">
            ...
            <p className="act-card__badge act-card__badge--premium">🌟 Premium – Target Lounge</p>
            <p className="act-badge-desc">Curated groups based on your relocation phase.</p>
          </div>
        </div>
        <div className="act-col">
          <div className="act-card">
        ...
        <div className="act-col">
          <div className="act-card">
            ...
            <div className="act-mentor-row">
              <div className="act-mentor-avatar">👨</div>
              <div><p className="act-mentor-name">Marco</p><p className="act-mentor-route">Living in {cityName} · 2 Years</p></div>
            </div>
            <p className="act-mentor-insight"><strong>Get insider advice from someone who already navigated this.</strong></p>
          </div>
          <div className="act-card">
            <h3 className="act-card__title">📊 BUDGET CHECK</h3>
            <p className="act-budget-row">🏠 Estimated Monthly Cost — €2,075</p>
            <p className="act-budget-row">💳 Your Declared Budget — €2,500</p>
            <p className="act-budget-result act-budget-result--ok">● Financially Sustainable</p>
          </div>
          <div className="act-card">
            <h3 className="act-card__title">🔄 PLATFORM SUPPORT</h3>
            {["Get Answers To Your Questions", "Understand The Next Step", "Find The Right People"].map((i) => (
              <p key={i} className="act-check-item">✓ {i}</p>
            ))}
          </div>
        </div>
      </div>
...
function ActivationComparison({ currentCity = "Milan", targetCity = "Valencia", budget = 2500, estimatedCost = 2075, score = 70 }: {
  ...
  return (
    <div className="activation-main">
      ...
      <div className="activation-header">
        <h1 className="activation-title">See How Your Life Could Change In {targetCity}</h1>
        <p className="activation-subtitle">
          Based On Your Profile, Syncro Compares {currentCity} And {targetCity} To Show How Your Cost Of Living,<br />
      ...
      <div className="activation-grid">
        <div className="act-col">
          ...
          <div className="act-card act-card--warning">
            <h3 className="act-card__title" style={{ color: '#d4900a' }}>⚠ Hidden Risk</h3>
            {[
              { label: "Find The Right Housing", body: `Rent Prices May Rise Quickly. Syncro Suggests Budget-Compatible Neighborhoods And Safer Options.` },
            ].map((r) => (
              <div key={r.label} className="act-month">
                <p className="act-month__title"><strong>{r.label}</strong></p>
        ...
        <div className="act-col">
          <div className="act-card">
            ...
            <div className="act-mentor-row">
              ...
              <div>
                <p className="act-mentor-name">Marco</p>
                <p className="act-mentor-route">{currentCity} → {targetCity} · In 4 Months</p>
              </div>
            </div>
            <p className="act-mentor-insight"><strong>People Who Relocated With This Structure Avoided Up To €6,000 In Early Mistakes.</strong></p>
            <div className="act-mentor-tiers">
          ...
          <div className="act-card">
            ...
            {MACRO_COMPARISON.map((m) => (
              <div key={m.label} className="act-comparison-row">
                ...
                <div className="act-comparison-bars">
                  <div className="act-bar act-bar--current" style={{ width: `${m.currentScore}%` }} title={`${currentCity}: ${m.currentScore}`} />
                  <div className={`act-bar ${m.direction === 'improvement' ? 'act-bar--target-good' : 'act-bar--target-bad'}`} style={{ width: `${m.targetScore}%` }} title={`${targetCity}: ${m.targetScore}`} />
                </div>
                <span className={`act-comparison-delta ${m.direction === 'improvement' ? 'act-delta--up' : 'act-delta--down'}`}>
                  {m.direction === 'improvement' ? '↑' : '↓'} {Math.abs(m.targetScore - m.currentScore)}
                </span>
              </div>
            ))}
            ...
            <p className="act-budget-row">🏠 Estimated Monthly Cost — €{estimatedCost.toLocaleString()}</p>
            <p className="act-budget-row">💳 Your Declared Budget — €{budget.toLocaleString()}</p>
            <p className="act-budget-row">📈 Remaining Margin — €{margin.toLocaleString()}</p>
            <p className={`act-budget-result ${margin >= 0 ? 'act-budget-result--ok' : 'act-budget-result--risk'}`}>
          ...
          <div className="act-card">
            ...
            <h3 className="act-card__title">🔄 PLATFORM SUPPORT</h3>
            <p className="act-card__subtitle">Sometimes You Just Need Clarity.</p>
            {["Get Answers To Your Questions", "Understand The Next Step", "Find The Right People And Resources"].map((i) => (
              <p key={i} className="act-check-item">✓ {i}</p>
            ))}
          </div>
        </div>
...
function NextActionsBanner({ action, description, onAction, isLoading }: {
  action: string; description: string; onAction: () => void; isLoading: boolean;
}) {
    ...
    <div className="act-next-banner">
      <div className="act-next-banner__left">
        <span className="act-next-banner__icon">
          {action === "complete_onboarding" ? "📋" : action === "create_snapshot" ? "📸" : action === "compute_scoring" ? "🧮" : "📊"}
        </span>
        <div>
      ...
      <button className="act-next-banner__btn" onClick={onAction} disabled={isLoading}>
...
function RealScoringCard({ scores }: { scores: CityScoreResponse[] }) {
  ...
  const top = scores[0];
  const radarData = Object.entries(top.radarValues ?? {}).map(([key, value]) => ({
  ...
  return (
    <div className="act-card act-card--scoring">
      ...
      <div style={{ textAlign: 'center', marginBottom: 12 }}>
        ...
        <span className="act-compat-badge" style={{
          background: top.compatibilityLevel === "VERY_STRONG_FIT" ? "#3b6bdc" : top.compatibilityLevel === "GOOD_FIT" ? "#22a55f" : "#f2b203"
        }}>{top.compatibilityLevel?.replace(/_/g, ' ')}</span>
      </div>
      {radarData.length > 0 && <div style={{ display: 'flex', justifyContent: 'center' }}><RadarChart data={radarData} size={180} /></div>}
      {top.insights && (
        <div className="act-insights">
          {top.insights.strengths?.map((s: string) => <p key={s} className="act-check-item">✓ {s}</p>)}
          {top.insights.warnings?.map((w: string) => <p key={w} className="act-warning-item">⚠ {w}</p>)}
        </div>
      )}
    </div>
  );
...
export default function ActivationPage() {
  const {
    activationState, onboarding, scoringResult,
    loadActivationState, loadOnboarding, createSnapshot, computeScoring, isLoading,
  } = useExpats();
  ...
  const handleNextAction = async (action: string) => {
    ...
    try {
      if (action === "create_snapshot") {
        ...
        document.querySelector(".act-scoring-wrap")?.scrollIntoView({ behavior: "smooth" });
      }
    } catch {
  ...
  const cityName = onboarding?.targetCityName ?? onboarding?.currentCityName ?? "Lisbon";
  const budget = onboarding?.monthlyBudget ?? 2500;
  const nextAction = activationState?.nextActions?.[0];
  const isComparison = !!(onboarding?.currentCityName && onboarding?.targetCityName && onboarding?.targetCityId);

  const renderVariant = () => {
    if (isComparison) {
      return <ActivationComparison currentCity={onboarding?.currentCityName ?? "Milan"} targetCity={onboarding?.targetCityName ?? "Valencia"} budget={budget} />;
    }
    if (userType === "already_in_city") {
      return <ActivationAlreadyThere cityName={onboarding?.currentCityName ?? "Lisbon"} />;
    }
