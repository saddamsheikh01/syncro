...
export interface AdminCityDatasetResponse {
  ...
  apartment1brOutside: number | null;
  apartment3brOutside: number | null;
  utilitiesMonthly: number | null;
  mobilePlanMonthly: number | null;
  internetMonthly: number | null;
  mealForTwoMidrange: number | null;
  gasolinePerLiter: number | null;
  publicTransportMonthly: number | null;
  preschoolMonthly: number | null;
  internationalSchoolAnnual: number | null;
...
export type AdminCreateCityPayload = {
  ...
  costSingleNoRent: number;
  costFamilyNoRent: number;
  apartment1brOutside?: number;
  apartment3brOutside?: number;
  utilitiesMonthly?: number;
  mobilePlanMonthly?: number;
  internetMonthly?: number;
  mealForTwoMidrange?: number;
